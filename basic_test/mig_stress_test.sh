...
PYTHON_SCRIPT="./mig_memory_stress.py"
...
# Initialize logs
echo "==================================" | tee -a "$MAIN_LOG"
echo "MIG Stress Test Started: $(date)" | tee -a "$MAIN_LOG"
echo "==================================" | tee -a "$MAIN_LOG"
echo "" | tee -a "$MAIN_LOG"
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("Usage: python3 mig_memory_stress.py <device_uuid> <duration_seconds> <log_file>")
        sys.exit(1)
